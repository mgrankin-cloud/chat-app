...
import (
	usergrpc "Messenger-android/messenger/message-service/message/internal/grps/message"
	"context"
	"fmt"
...
func New(
	log *slog.Logger,
	messageService messagegrpc.Message,
	port int,
) *App {
	...
	usergrpc.RegisterMessageService(gRPCServer, messageService)
