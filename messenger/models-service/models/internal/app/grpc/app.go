...
import (
	modelsgrpc "Messenger-android/messenger/models-service/models/internal/grpc/models"
	"context"
	"fmt"
...
func New(
	log *slog.Logger,
	modelsService modelsgrpc.Models,
	port int,
) *App {
	...
	modelsgrpc.RegisterModelsService(gRPCServer, modelsService)
