...
import (
	authgrpc "Messenger-android/messenger/media-service/media/internal/grpc/media"
	mediagrpc "Messenger-android/messenger/media-service/media/internal/grpc/media"
	"context"
	"fmt"
...
func New(
	...
	authgrpc.Register(gRPCServer, mediaService)
