...
func (x *AuthenticateRequest) GetAppId() int32 {
	if x != nil {
		return x.AppId
	}
	return 0
...
func (x *AuthenticateResponse) GetSessionId() int64 {
	if x != nil {
		return x.SessionId
	}
	return 0
...
func (x *CheckAuthenticationRequest) GetSessionId() int64 {
	if x != nil {
		return x.SessionId
	}
	return 0
...
type CheckAuthenticationResponse struct {
	...
	Authenticated string `protobuf:"bytes,1,opt,name=authenticated,proto3" json:"authenticated,omitempty"`
...
func (x *CheckAuthenticationResponse) GetAuthenticated() string {
	if x != nil {
...
func (x *CheckAuthenticationResponse) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0x68, 0x0a, 0x13, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74,
	0x69, 0x63, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1e, 0x0a, 0x0a,
	...
	0x7f, 0x0a, 0x14, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74, 0x69, 0x63, 0x61, 0x74, 0x65, 0x52,
	...
	0x22, 0x3b, 0x0a, 0x1a, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74,
	...
	0x28, 0x03, 0x52, 0x09, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0x5c, 0x0a,
	0x1b, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74, 0x69, 0x63, 0x61,
	...
	0x65, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x2e, 0x0a, 0x0d, 0x4c,
	...
	0x65, 0x22, 0x75, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x71,
	...
	0x09, 0x52, 0x05, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x22, 0x5f, 0x0a, 0x10, 0x52, 0x65, 0x67, 0x69,
	...
	0x03, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x29, 0x0a, 0x0e, 0x49, 0x73, 0x41,
	...
	0x69, 0x6e, 0x32, 0xd1, 0x02, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x45, 0x0a, 0x0c, 0x41,
	...
	0x73, 0x65, 0x12, 0x5a, 0x0a, 0x13, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x41, 0x75, 0x74, 0x68, 0x65,
	0x6e, 0x74, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x20, 0x2e, 0x61, 0x75, 0x74, 0x68,
	0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74, 0x69, 0x63, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x21, 0x2e, 0x61, 0x75,
	0x74, 0x68, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x41, 0x75, 0x74, 0x68, 0x65, 0x6e, 0x74, 0x69,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x1d, 0x5a, 0x1b, 0x6d, 0x67, 0x72, 0x61, 0x6e, 0x6b,
...
var file_sso_sso_proto_goTypes = []any{
	...
	(*CheckAuthenticationRequest)(nil),  // 2: auth.CheckAuthenticationRequest
	(*CheckAuthenticationResponse)(nil), // 3: auth.CheckAuthenticationResponse
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	2, // 1: auth.Auth.CheckAuthentication:input_type -> auth.CheckAuthenticationRequest
	...
	1, // 5: auth.Auth.Authenticate:output_type -> auth.AuthenticateResponse
	3, // 6: auth.Auth.CheckAuthentication:output_type -> auth.CheckAuthenticationResponse
...
func file_sso_sso_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sso_sso_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*CheckAuthenticationRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_sso_sso_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*CheckAuthenticationResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
